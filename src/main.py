...
def my_main(_run, _config, _log):
    ...
    th.cuda.set_device(config["cuda_id"])  # Specify the GPU
...
if __name__ == '__main__':
    ...
    # Minghong: swap the sequence of the update to make sure the runner option env_config can overwrite in env_config.
