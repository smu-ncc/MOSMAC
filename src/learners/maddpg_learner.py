...
class MADDPGLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        device = args.cuda_id if args.use_cuda else "cpu" #device = "cuda" if args.use_cuda else "cpu"
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        if t_env - self.log_stats_t >= self.args.learner_log_interval:
            ...
            # self.logger.log_stat("agent_grad_norm", agent_grad_norm, t_env)  # this line cause a bug. The agent_grad_norm is duplicated.
